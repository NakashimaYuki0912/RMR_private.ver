...
foreach ($equipId in '260005','260006','260007','260008','260009','260010','260011','260012','260013','260014') {
    if ($equipIds -notcontains $equipId) {
        $failures.Add("chapter 7 Reverberation Ensemble core-page pool missing $equipId")
    }
}
if ($equipIds -contains '260001') {
    $failures.Add('chapter 7 core-page pool should not remain Hana-only')
}
